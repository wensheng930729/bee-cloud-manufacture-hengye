    ...
    form.validateFieldsAndScroll((errors, values) => {
      ...
      if (!errors) {
        ...
        request(apis.validate.api({ phone, code, type: 0 }), { method: apis.validate.type }).then(res => {
          ...
          //注册
          if (status) {
            return request(apis.resetPassword.api(), { method: apis.resetPassword.type, body: { phone, password, name: '' } })
          } else {
            return {}
          }
        }).then(res => {
          if (res && res.code === 0) {
            message.success('重置密码成功！', 1.5, () => { router.replace('/login') })
          } else {
      ...
      <div className={styles.panel}>
        ...
        <div className={styles.wraper}>
          ...
          <div className={styles.right}>
            <Form>
              ...
              <div className={`${styles.userName} ${styles.pre}`}>
                <FormItem>
                  ...
                  })(<Input maxLength={11} prefix={<span className={styles.icon}>+86</span>} onPressEnter={this.handleOk.bind(this)} placeholder='11位手机号' />)}
                </FormItem></div>
              <div className={styles.code}>
                <div className={styles.input_}>
                  <FormItem>
                    ...
                    })(<Input placeholder="输入验证码" type='number' autoComplete={false} onPressEnter={this.handleOk.bind(this)} autoCapitalize={false} />)}
                  </FormItem>
            ...
            <div className={styles.button} onClick={this.handleOk.bind(this)}>重置</div>
