...
import { api_factory_prefix, api_user_prefix } from '@/constants/prefix';
...
// 获取用户供应商列表
export async function getSupplierListByCategory(params) {
...
// 保存采购地磅数据信息
export async function saveBuyWeightMachine(params) {
  return request(`${api_factory_prefix}/weightMachine/saveBuyWeightMachine`, {
    method: 'POST',
    body: params
  });
}
...
// 通知取样
export async function samplePush(str) {
  return request(`${api_factory_prefix}/weightMachine/samplePush?${str}`, {
    method: 'GET'
  });
}
