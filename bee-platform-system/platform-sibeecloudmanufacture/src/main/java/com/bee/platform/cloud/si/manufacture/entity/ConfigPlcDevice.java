...
public class ConfigPlcDevice extends Model<ConfigPlcDevice> {
     ...
     * PLC名称
     */
    @Excel(name = "PLC名称" ,orderNum = "4",width = 20)
    private String name;
    /**
     * 品牌
     */
    @Excel(name = "品牌" ,orderNum = "5",width = 20)
     ...
     * 型号
     */
    @Excel(name = "型号" ,orderNum = "7",width = 20)
    private String type;
    /**
     * 是否删除 0未删除 1删除
     */
