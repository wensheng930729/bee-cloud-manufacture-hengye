...
@TableName("sale_transport_section")
public class SaleTransportSection extends Model<SaleTransportSection> {

    private static final long serialVersionUID = 2143982292084427324L;
