...
@TableName("buy_carrier_transport")
public class BuyCarrierTransport extends Model<BuyCarrierTransport> {

    private static final long serialVersionUID = -6274964874813174417L;
