...
@TableName("buy_transport_section")
public class BuyTransportSection extends Model<BuyTransportSection> {

    private static final long serialVersionUID = 470548142789855746L;
