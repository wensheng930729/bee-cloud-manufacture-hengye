...
public class ConfigTestAttribute extends Model<ConfigTestAttribute> {
     ...
     * 属性编码
     */
    @Excel(name = "属性编码" ,orderNum = "4",width = 20)
    private String code;
    /**
     * 化验属性名称
     */
    @Excel(name = "化验属性名称" ,orderNum = "5",width = 20)
    private String attributeName;
    /**
     * 化验类型（0 输入项  1 输出项）
     */
    @Excel(name = "化验类型（0 输入项  1 输出项）", orderNum = "6", type = 10, width = 20)
