 ...
 * @Description druid 配置. 这样的方式不需要添加注解：@ServletComponentScan 使用：http://127.0.0.1:8820/platform-cloudmanufactureuser/druid/index.html
   *                 或者http://127.0.0.1:8820/platform-cloudmanufactureuser/druid这个地址就能访问数据库的监控了
 * @author zhigang.zhou
